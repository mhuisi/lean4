...
lean_ctor_set(v___x_583_, 2, v___y_552_);
...
v___x_645_ = l_Lean_Syntax_getTailPos_x3f(v___y_641_, v___y_643_);
lean_dec(v___y_641_);
...
v___x_1440_ = l_Lean_Meta_subCounters___at___00__private_Lean_Linter_TacticTypeCheck_0__Lean_Linter_tacticCheckInstances_spec__5(v___y_1433_, v_unfoldCounter_1438_);
...
v___y_1433_ = v_unfoldCounter_1515_;
