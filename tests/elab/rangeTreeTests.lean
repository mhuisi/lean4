...
/-! ## Tests for Array.binSearchRightmost -/

-- Empty array returns none
#guard (Array.binSearchRightmost #[] 5 id (· < ·)).isNone

-- Single element array - exact match
#guard (Array.binSearchRightmost #[5] 5 id (· < ·) == some (0, 5))

-- Single element array - query larger than element (returns element)
#guard (Array.binSearchRightmost #[5] 10 id (· < ·) == some (0, 5))

-- Single element array - query smaller than element (returns none)
#guard (Array.binSearchRightmost #[5] 3 id (· < ·)).isNone

-- Multiple elements - exact match at end
#guard (Array.binSearchRightmost #[1, 3, 5, 7, 9] 9 id (· < ·) == some (4, 9))

-- Multiple elements - exact match at start
#guard (Array.binSearchRightmost #[1, 3, 5, 7, 9] 1 id (· < ·) == some (0, 1))

-- Multiple elements - exact match in middle
#guard (Array.binSearchRightmost #[1, 3, 5, 7, 9] 5 id (· < ·) == some (2, 5))

-- Multiple elements - query between elements (returns next smaller)
#guard (Array.binSearchRightmost #[1, 3, 5, 7, 9] 6 id (· < ·) == some (2, 5))

-- Multiple elements - query larger than all (returns last)
#guard (Array.binSearchRightmost #[1, 3, 5, 7, 9] 100 id (· < ·) == some (4, 9))

-- Multiple elements - query smaller than all (returns none)
#guard (Array.binSearchRightmost #[1, 3, 5, 7, 9] 0 id (· < ·)).isNone

-- Duplicate elements - returns rightmost
#guard (Array.binSearchRightmost #[1, 3, 3, 3, 5] 3 id (· < ·) == some (3, 3))

-- With key function - search by first element of pair
#guard (Array.binSearchRightmost #[(1, "a"), (3, "b"), (5, "c")] 3 (·.1) (· < ·) == some (1, (3, "b")))

-- With key function - query between elements
#guard (Array.binSearchRightmost #[(1, "a"), (3, "b"), (5, "c")] 4 (·.1) (· < ·) == some (1, (3, "b")))

/-! ## Tests for Array.binSearchLeftmost -/

-- Empty array returns none
#guard (Array.binSearchLeftmost #[] 5 id (· < ·)).isNone

-- Single element array - exact match
#guard (Array.binSearchLeftmost #[5] 5 id (· < ·) == some (0, 5))

-- Single element array - query smaller than element (returns element)
#guard (Array.binSearchLeftmost #[5] 3 id (· < ·) == some (0, 5))

-- Single element array - query larger than element (returns none)
#guard (Array.binSearchLeftmost #[5] 10 id (· < ·)).isNone

-- Multiple elements - exact match at end
#guard (Array.binSearchLeftmost #[1, 3, 5, 7, 9] 9 id (· < ·) == some (4, 9))

-- Multiple elements - exact match at start
#guard (Array.binSearchLeftmost #[1, 3, 5, 7, 9] 1 id (· < ·) == some (0, 1))

-- Multiple elements - exact match in middle
#guard (Array.binSearchLeftmost #[1, 3, 5, 7, 9] 5 id (· < ·) == some (2, 5))

-- Multiple elements - query between elements (returns next larger)
#guard (Array.binSearchLeftmost #[1, 3, 5, 7, 9] 4 id (· < ·) == some (2, 5))

-- Multiple elements - query smaller than all (returns first)
#guard (Array.binSearchLeftmost #[1, 3, 5, 7, 9] 0 id (· < ·) == some (0, 1))

-- Multiple elements - query larger than all (returns none)
#guard (Array.binSearchLeftmost #[1, 3, 5, 7, 9] 100 id (· < ·)).isNone

-- Duplicate elements - returns leftmost
#guard (Array.binSearchLeftmost #[1, 3, 3, 3, 5] 3 id (· < ·) == some (1, 3))

-- With key function - search by first element of pair
#guard (Array.binSearchLeftmost #[(1, "a"), (3, "b"), (5, "c")] 3 (·.1) (· < ·) == some (1, (3, "b")))

-- With key function - query between elements
#guard (Array.binSearchLeftmost #[(1, "a"), (3, "b"), (5, "c")] 2 (·.1) (· < ·) == some (1, (3, "b")))
